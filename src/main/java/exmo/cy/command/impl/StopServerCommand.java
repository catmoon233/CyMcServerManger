...
public class StopServerCommand extends AnnotatedCommand {
    ...
    public boolean execute(String[] args) {
        ...
        Logger.println(ConsoleColor.colorize(ConsoleColor.BRIGHT_BLUE, "输入要停止的服务器序号: "));
        try {
            ...
            Logger.println(ConsoleColor.colorize(ConsoleColor.GREEN, "已发送停止指令到服务器 " + instance.getServer().getName()));
        } catch (Exception e) {
            Logger.println(ConsoleColor.colorize(ConsoleColor.RED, "停止服务器时出错: " + e.getMessage()));
        }
