...
@CommandAnnotation(
    name = "force-stop",
    aliases = {"fs", "kill"},
    description = "强制停止指定服务器"
)
public class ForceStopCommand extends AnnotatedCommand {
    private final ServerService serverService;
    private final Scanner scanner = new Scanner(System.in);
    
    public ForceStopCommand(ServerService serverService) {
    ...
    public boolean execute(String[] args) {
        ...
        System.out.print(ConsoleColor.colorize(ConsoleColor.BRIGHT_BLUE, "输入要强制停止的服务器序号: "));
        try {
            ...
            System.out.println(ConsoleColor.colorize(ConsoleColor.GREEN, "服务器 " + instance.getServer().getName() + " 已强制关闭"));
        } catch (Exception e) {
            System.out.println(ConsoleColor.colorize(ConsoleColor.RED, "强制停止服务器时出错: " + e.getMessage()));
        }
